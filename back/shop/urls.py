...
from users.views import RegisterView,LoginView,CustomTokenObtainPairView,HelloView,RegisterAdminView
from rest_framework_simplejwt.views import TokenRefreshView, TokenVerifyView
from users.CRUD_users import UsersView, UserIdView
from products.planktons_views import PlanktonIDView, PlanktonView
...
urlpatterns = [
    ...
    path('planktons/',PlanktonView.as_view(), name='HomePage'),
    path('planktons/<int:plankton_id>',PlanktonIDView.as_view(), name='single_products'),
    path('admin/register/', RegisterAdminView.as_view(), name="create_admin")
]
